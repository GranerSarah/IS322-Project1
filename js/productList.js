...
// mock database of shoes
    ...
    function renderProducts(database) {
        ...
        database.forEach(function(product) {
            ...
            const productCard = '<article class=\"productCard\"><img class=\"productImage\" alt=\"shoe\"src=\"' + product.image + '.jpg\" /><p class=\"productName\">' + product.name + '</p><p class=\"productPrice\">$' + product.price + '</p></article>';
